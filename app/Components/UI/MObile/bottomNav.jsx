...
export default function BottomNavbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-md z-50 lg:hidden">
      <div className="flex justify-around items-center h-14">
        ...
        <Link href="/Profile/Orders" className="flex flex-col items-center text-sm text-gray-700 hover:text-red-600">
          ...
          Orders
            ...
            <Link href="/Catagories" className="flex flex-col items-center text-sm text-gray-700 hover:text-red-600">
          <Group size={20} />
        Catagories
        </Link>
