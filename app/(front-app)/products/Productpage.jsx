...
function ProdcutPage() {
        ...
        <div className="info w-full md:w-1/2 flex flex-col justify-start md:gap-4 gap-3">
          ...
          <div className="sizes flex gap-2 mt-4">
            {(product?.sizes || ['XS', 'M', 'L']).map((size, index) => (
              <span
                ...
                className={`cursor-pointer px-3 py-1 border border-gray-300 rounded-md ${Size === size &&
          ...
          <div className="order mt-3 w-full">
            ...
            <div className="buttons hidden md:flex flex-col md:flex-row gap-3">
              ...
              <button
                ...
                disabled={!Size}
                className={`addToCart px-4 py-2 w-full rounded text-white ${!Size ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-500 hover:bg-red-600'
                  }`}
              >
                Add to Cart
              </button>
          ...
          <div className="butNowBtn w-full">
            <button
              ...
              disabled={!Size}
              className={`addToCart px-4 py-2 w-full rounded-sm font-bold border-2 transition-all duration-300 ${!Size ? 'bg-gray-400 cursor-not-allowed' : 'bg-white hover:bg-black hover:text-white'
                }`}
            >
              Buy Now
            </button>
  ...
  <div className="mb-4">
    <p className="text-sm text-gray-600 mb-2">You don't have any saved addresses.</p>
    <button
